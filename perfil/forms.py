...
class UserForm(forms.ModelForm):
    ...
    def clean(self, *args, **kwargs):
        ...
        error_msg_passord_match = 'As senhas não conferem'
        error_msg_passord_short = 'Senha muito curta, pelo menos 6 caracteres'
        ...
        if self.usuario:
            ...
            if password_data:
                if password_data != password2_data:
                    validation_error_messages['password'] = error_msg_passord_match
                    validation_error_messages['password2'] = error_msg_passord_match

                if len(password_data) < 6:
                    validation_error_messages['password'] = error_msg_passord_short        
